...
class MemberLoveListViewActivity : AppCompatActivity(), GoogleMapAPISerive.GetResponse, MfirebaeCallback {
    ...
    inner class MyAdapter(var mAllData: ArrayList<GoogleMapPlaceDetailsData>?) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (convertView == null)
                convertView = LayoutInflater.from(this@MemberLoveListViewActivity).inflate(
            ...
            mTittleText.text =data.result.name
            if(data.result.photos[0].photo_reference!=null){
                var  photoString:String = GoogleMapAPISerive.getPhotos(this@MemberLoveListViewActivity,data.result.photos[0].photo_reference)
